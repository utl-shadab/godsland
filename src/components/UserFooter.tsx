...
const UserFooter = () => {
  return (
 <footer className="lg:ml-[230px] bg-[#020D07] border-t border-[#0D2B1F]">
        <div className="max-w-[1200px] mx-auto py-10 px-6 md:px-10">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-2">
                {[0, 1, 2].map((i) => (
                  <button
                    key={i}
                    className="w-9 h-9 rounded-lg border border-[#0D2B1F] hover:border-[#20FFB0]/30 flex items-center justify-center transition-colors duration-200"
                  >
                    <div className="w-3 h-3 rounded-full bg-[#20FFB0]/50" />
                  </button>
                ))}
              </div>
            </div>
              ...
              <div key={col.title}>
                ...
                <ul className="space-y-2">
                  {col.items.map((item) => (
                    <li
                      key={item}
                      className="text-[#4A7A65] font-readex text-xs hover:text-[#20FFB0] cursor-pointer transition-colors duration-200"
                    >
                      {item}
                    </li>
                  ))}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-10 rounded-lg bg-[#0A2219] border border-[#1A4A35] px-3 pr-12 text-[#8DE0C3] font-readex text-xs outline-none focus:border-[#20FFB0]/40 transition-colors duration-200"
                />
                <button className="absolute right-1 top-1 w-8 h-8 rounded-md bg-[#20FFB0] flex items-center justify-center hover:bg-[#20FFB0]/90 transition-colors duration-200">
          ...
          <div className="pt-6 border-t border-[#0D2B1F] text-center">
