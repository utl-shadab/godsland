...
const HeroSection = () => {
  ...
  return (
    <section
      className="relative w-full min-h-screen flex flex-col pt-32 pb-12 items-center overflow-hidden px-8 z-10 bg-black"
      ref={containerRef}
    >
      ...
      <canvas
        ref={canvasRef}
        className="absolute top-0 left-0 w-full h-full -z-5 opacity-60 pointer-events-none"
      />
      ...
      <div className="text-center max-w-[1400px] w-full z-20 flex flex-col items-center">
        <div className="overflow-hidden mb-2">
          ...
          >
            Unique Collection
            <span className="block mt-2">Of NFT Arts</span>
          </h1>
        </div>
        ...
        <div className="overflow-hidden mb-8 max-w-2xl">
          <p
            ...
            ref={subtitleRef}
          >
            The largest collection of nft artifacts among all marketplaces.
            Discover, collect, and sell extraordinary NFTs.
          </p>
        </div>

        <div
          className="flex gap-6 justify-center mt-2 opacity-0 transform translate-y-5"
          ref={ctaRef}
        >
          <Link
            to="/explore"
            className="group relative py-3 px-8 text-sm font-bold uppercase tracking-widest rounded-full overflow-hidden bg-neon-green text-black transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,163,0.5)] hover:scale-105"
          >
