    ...
    return (
        <div className="w-full bg-[#0b0b0b] border border-white/5 rounded-2xl overflow-hidden mb-12">
            <div className="p-6 border-b border-white/5">
                <h3 className="text-xl font-bold text-white uppercase tracking-wider">Auction History</h3>
            </div>
                            ...
                            <tr key={item.id} className="hover:bg-white/5 transition-colors">
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-2 text-gold-primary">
                                        <User size={14} />
                                        <span className="font-mono text-sm">{item.winner || '---'}</span>
                                        <ExternalLink size={12} className="opacity-50 hover:opacity-100 cursor-pointer" />
                                    </div>
                                </td>
                                <td className="px-6 py-4 text-right">
                                    <span className="text-neon-green font-bold tabular-nums">{item.currentBid}</span>
                                </td>
                                <td className="px-6 py-4 text-right">
                                    <span className="text-white font-medium tabular-nums">{item.bids}</span>
                                </td>
