...
export const UserSidebar = ({ mobile = false }) => (
  <nav className="flex flex-col h-full">
    ...
    <div className="p-4 mt-auto">
      <div className="rounded-xl border border-[#00d32c]/10 bg-[#0A2A1E] p-4">
        <p className="text-[#00d32c] font-readex text-xs font-semibold mb-1">
          Need help?
        </p>
        <p className="text-[#6B9E8B] font-readex text-xs leading-relaxed">
          Visit our support center anytime.
        </p>
        <button className="mt-3 w-full h-8 rounded-lg bg-[#00d32c]/10 border border-[#00d32c]/20 text-[#00d32c] font-readex text-xs font-semibold hover:bg-[#00d32c]/20 transition-colors duration-200">
          Get Support
        </button>
      </div>
    </div>
