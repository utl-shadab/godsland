...
const UserHeader = ({ setMobileMenuOpen }: { setMobileMenuOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {
  return (
    <motion.header
      ...
      className="fixed top-0 left-0 lg:left-[230px] right-0 h-[68px] z-30 backdrop-blur-[20px] bg-[#020F0A]/80 border-b border-[#00d32c]"
    >
      <div className="h-full px-4 md:px-6 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Notifications */}
          <button className="relative w-9 h-9 rounded-lg bg-[#0A2219] border border-[#1A4A35] flex items-center justify-center hover:border-[#00d32c]/30 transition-colors duration-200">
            ...
            <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-[#00d32c] border-2 border-[#020F0A]" />
          </button>
