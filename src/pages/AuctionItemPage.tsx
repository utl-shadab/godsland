            ...
            <div className="lg:sticky lg:top-28">
              ...
              <div className="bg-[#111] border border-white/5 rounded-xl p-4 md:p-6 mt-4 md:mt-6">
                ...
                <p className="text-gray-400 text-xs md:text-sm leading-relaxed">
                  Created by the renowned digital artist, this piece explores
                  the intersection of nature and technology. Featuring
                  generative patterns and organic textures, it represents the
                ...
                <div className="mt-3 md:mt-4 pt-3 md:pt-4 border-t border-white/5 flex flex-col gap-2">
                  <div className="flex justify-between text-xs md:text-sm">
                    ...
                    <span className="text-blue-400 font-mono cursor-pointer hover:underline truncate ml-4">
                      0x7a9d...4f3e
                    </span>
                  </div>
                  <div className="flex justify-between text-xs md:text-sm">
            ...
            <div className="bg-[#111] border border-white/5 rounded-xl md:rounded-2xl p-4 md:p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-5 md:mb-6">
                ...
                <div>
                  ...
                  <p className="text-white font-bold tabular-nums text-base md:text-lg">
                    -
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-neon-green font-bold tabular-nums text-base md:text-lg">
                    5%
                  </p>
                </div>
                <div>
                ...
                <div className="text-xs md:text-sm font-medium text-gray-400 flex items-center gap-2 bg-white/5 px-3 md:px-4 py-2 rounded-lg border border-white/5">
                  ...
                  <CountdownTimer
                    ...
                    onEnd={() => {
                      ...
                      setTimeout(() => {
                        const mockOrderId =
                          "ord_" + Math.random().toString(36).substr(2, 9);
              ...
              <div className="flex flex-col gap-3 border-t border-white/5 pt-4">
                <div className="flex justify-between items-center text-xs md:text-sm">
                  ...
                  <span className="text-neon-green cursor-pointer hover:underline font-medium">
                    0x3f...8a2b
                  </span>
                </div>
                <div className="flex justify-between items-center text-xs md:text-sm border-t border-white/5 pt-3">
                  ...
                  <div className="flex items-center gap-1 text-neon-green cursor-pointer hover:underline font-medium">
                    <span className="w-4 h-4 rounded-full bg-neon-green/20 flex items-center justify-center text-[8px] text-neon-green">
                      💠
                    </span>
              ...
              <div className="flex gap-4 md:gap-6 border-b border-white/10 mb-0">
                {["Bids", "Details", "Deal Info"].map((tab) => (
                  <button
                    ...
                    className={`pb-3 text-xs md:text-sm font-bold tracking-wide border-b-2 transition-colors relative top-[1px] ${
                      activeTab === tab
                  ...
                  >
                    {tab}{" "}
                    {tab === "Bids" && (
                      <span className="ml-1 bg-neon-green text-black text-[10px] px-1.5 py-0.5 rounded-sm font-bold">
                        25
                      </span>
                    )}
                  </button>
                  ...
                  <div className="p-3 md:p-4">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 text-xs md:text-sm bg-white/5 p-3 md:p-4 rounded-lg">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded bg-neon-green/20 text-neon-green text-[10px] md:text-xs font-bold uppercase tracking-wider">
                          Fragment
                        </span>
                        <span className="text-neon-green font-mono text-[10px] md:text-xs cursor-pointer hover:underline">
                          EQBAjaOy...Kpkla9nE
                        </span>
                      </div>
                    </div>
