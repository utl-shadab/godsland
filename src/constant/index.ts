...
export const HeroContent= [
    {
        ...
        redirect:'/collections?category=luxury',
        current_bid: "0.5 ETH",
        image: one,
    },
    {
        ...
        redirect: '/collections?category=business',
        current_bid: "0.5 ETH",
        image: two,
    },
    {
        ...
        redirect: '/collections?category=wellness',
        current_bid: "0.5 ETH",
        image: three,
    },
    {
        ...
        redirect: '/collections?category=entertainment',
        current_bid: "0.5 ETH",
        image: four,
    },
    {
        ...
        redirect: '/collections?category=art',
        current_bid: "0.5 ETH",
        image: five,
    }
